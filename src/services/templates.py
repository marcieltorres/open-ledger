...
_TEMPLATES: dict[AccountTemplate, list[AccountCreate]] = {
    AccountTemplate.merchant: [
        ...
        AccountCreate(code="2.2.002", name="PIS/COFINS Payable", account_type=AccountType.liability, currency=Currency.BRL),
        AccountCreate(code="2.2.003", name="CSLL/IRPJ Provision", account_type=AccountType.liability, currency=Currency.BRL),
        ...
        AccountCreate(code="4.2.002", name="Expense-PIS/COFINS", account_type=AccountType.expense, currency=Currency.BRL),
        AccountCreate(code="4.2.003", name="Expense-CSLL/IRPJ", account_type=AccountType.expense, currency=Currency.BRL),
    ],
    AccountTemplate.customer: [
        ...
        AccountCreate(code="4.1.001", name="Expense-Purchases", account_type=AccountType.expense, currency=Currency.BRL),
    ],
    AccountTemplate.operator: [
        AccountCreate(code=ACC_RECEIVABLES, name="Receivables", account_type=AccountType.asset, currency=Currency.BRL),
        AccountCreate(code="3.1.001", name="Revenue-Platform Fee", account_type=AccountType.revenue, currency=Currency.BRL),
        AccountCreate(code="4.1.001", name="Expense-White-label Fee", account_type=AccountType.expense, currency=Currency.BRL),
    ],
    AccountTemplate.platform: [
        AccountCreate(code=ACC_RECEIVABLES, name="Receivables", account_type=AccountType.asset, currency=Currency.BRL),
        AccountCreate(code="3.1.001", name="Revenue-Platform Fee", account_type=AccountType.revenue, currency=Currency.BRL),
        AccountCreate(code="3.1.002", name="Revenue-White-label Fee", account_type=AccountType.revenue, currency=Currency.BRL),
    ],
