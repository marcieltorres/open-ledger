...
_TEMPLATES: dict[AccountTemplate, list[AccountCreate]] = {
    AccountTemplate.MERCHANT: [
        ...
        AccountCreate(
            code="2.2.002", name="PIS/COFINS Payable", account_type=AccountType.LIABILITY, currency=Currency.BRL
        ),
        AccountCreate(
            code="2.2.003", name="CSLL/IRPJ Provision", account_type=AccountType.LIABILITY, currency=Currency.BRL
        ),
        ...
        AccountCreate(
            code="4.2.002", name="Expense-PIS/COFINS", account_type=AccountType.EXPENSE, currency=Currency.BRL
        ),
        AccountCreate(
            code="4.2.003", name="Expense-CSLL/IRPJ", account_type=AccountType.EXPENSE, currency=Currency.BRL
        ),
    ],
    AccountTemplate.CUSTOMER: [
        ...
        AccountCreate(
            code="4.1.001", name="Expense-Purchases", account_type=AccountType.EXPENSE, currency=Currency.BRL
        ),
    ],
    AccountTemplate.OPERATOR: [
        AccountCreate(code=ACC_RECEIVABLES, name="Receivables", account_type=AccountType.ASSET, currency=Currency.BRL),
        AccountCreate(
            code="3.1.001", name="Revenue-Platform Fee", account_type=AccountType.REVENUE, currency=Currency.BRL
        ),
        AccountCreate(
            code="4.1.001", name="Expense-White-label Fee", account_type=AccountType.EXPENSE, currency=Currency.BRL
        ),
    ],
    AccountTemplate.PLATFORM: [
        ...
        AccountCreate(
            code="3.1.002", name="Revenue-White-label Fee", account_type=AccountType.REVENUE, currency=Currency.BRL
        ),
    ],
