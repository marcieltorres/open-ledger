...
from src.model.enums import ReferenceType, TransactionStatus, TransactionType
...
class Transaction(BaseModel):
    ...
    reference_type: Mapped[ReferenceType | None] = mapped_column(String(100), nullable=True)
